...
sed -i 's#url-test#fallback#g' package/luci-app-openclash/luci-app-openclash/root/usr/share/openclash/yml_proxys_set.sh #修改openclash自动生成配置中的urltest为fallback
